                          ...
                          <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      ...
                                      <img src="/storage/products/{{$product->id}}/{{ $product->thumbnail_url }}" alt="" width="100px" height="100px">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                      ...
                                      <img src="/storage/products/{{$product->id}}/{{ $product->demo_url }}" alt="" width="100px" height="100px">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
