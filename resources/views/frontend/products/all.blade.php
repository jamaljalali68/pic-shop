    ...
    <div class="container">
        ...
        <div class="flex-w flex-sb-m p-b-52">
            ...
            <div class="dis-none panel-search w-full p-t-10 p-b-15">
                <form class="bor8 dis-flex p-l-15" action="{{ route('home.products.all') }}">
            ...
            <div class="dis-none panel-filter w-full p-t-10">
                <div class="wrap-filter flex-w bg6 w-full p-lr-40 p-t-27 p-lr-15-sm">
                    ...
                    <div class="filter-col1 p-r-15 p-b-27">
                        ...
                        <ul>
                            <li class="p-b-6">
                                <a href="#" onclick="addUrlParameter('filter2','free'); " class="filter-link stext-106 trans-04 filter-link-active">
                                    رایگان
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="#" onclick="addUrlParameter('filter2','notFree'); " class="filter-link stext-106 trans-04">
                                    پولی
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="filter-col2 p-r-15 p-b-27">
                        ...
                        <ul>
                            ...
                            <li class="p-b-6">
                                ...
                                <a href="#" onclick="addUrlParameter('filter2','priceSort1'); " class="filter-link stext-106 trans-04">
                            ...
                            <li class="p-b-6">
                                ...
                                <a href="#" onclick="addUrlParameter('filter2','priceSort2'); " class="filter-link stext-106 trans-04">
                            ...
                            <li class="p-b-6">
                                ...
                                <a href="#" onclick="addUrlParameter('filter2','priceSort3'); " class="filter-link stext-106 trans-04">
                    ...
                    <div class="filter-col3 p-r-15 p-b-27 mr-auto">
                        ...
                        <ul>
                            <li class="p-b-6">
                                <a href="#" onclick="addUrlParameter('filter','default'); " class="filter-link stext-106 trans-04">
                            ...
                            <li class="p-b-6">
                                <a href="#" onclick="addUrlParameter('filter','mostPopular'); " class="filter-link stext-106 trans-04">
                                    محبوبیت
                                </a>
                            </li>

                            <li class="p-b-6">
                                <a href="#" onclick="addUrlParameter('filter','newest'); " class="filter-link stext-106 trans-04 filter-link-active">
                                    جدیدترین
                                </a>
                            </li>
                            ...
                            <li class="p-b-6">
                                ...
                                <a href="#" onclick="addUrlParameter('filter','lowToHigh'); " class="filter-link stext-106 trans-04">
                                    قیمت:‌ کم به زیاد
                                </a>
                            </li>
                            ...
                            <li class="p-b-6">
                                ...
                                <a href="#" onclick="addUrlParameter('filter','highToLow'); " class="filter-link stext-106 trans-04">
                                    قیمت:‌زیاد به کم
                                </a>
                            </li>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item category{{ $product->category_id }}">
                ...
                <div class="block2">
                    <div class="block2-pic hov-img0">
                        <img src="/storage/products/{{$product->id}}/{{ $product->demo_url }}" alt="IMG-PRODUCT">

                        <a href="#" onclick="add('{{$product->id}}')" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-show-modal1">
                            مشاهده سریع
                        </a>
                    </div>
